...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/Hackcodepro/Avoidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Hackcodepro/LARBS/main/progs.csv"
